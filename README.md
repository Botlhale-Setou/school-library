...
### Usage
1. Install Ruby
2. Clone this repo `git clone https://github.com/Botlhale-Setou/school-library.git`
...
Feel free to check the [issues page](https://github.com/Botlhale-Setou/school-library/issues).
